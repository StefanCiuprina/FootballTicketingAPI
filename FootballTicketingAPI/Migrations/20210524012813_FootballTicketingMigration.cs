...
namespace FootballTicketingAPI.Migrations
{
    public partial class FootballTicketingMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeURL = table.Column<string>(type: "nvarchar(500)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<string>(type: "nvarchar(500)", nullable: false),
                    Stadium = table.Column<string>(type: "nvarchar(500)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Match_FootballClub_TeamAwayId",
                        column: x => x.TeamAwayId,
                        principalTable: "FootballClub",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Match_FootballClub_TeamHomeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Match_TeamAwayId",
                table: "Match",
                column: "TeamAwayId");

            migrationBuilder.CreateIndex(
                name: "IX_Match_TeamHomeId",
                table: "Match",
                column: "TeamHomeId");
